...
const burger = {
  ...
  discount: function(person){
    ...
    else return this.price - (this.price * 0.10)
  }
}
...
reviews.push ({name: 'Jonah', rating: 4, feedback: 'cool place'});
console.log(reviews)
...
function addReview(array, name, rating){
  return [{array, name, rating}]
}
console.log(reviews.push)
